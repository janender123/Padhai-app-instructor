          ...
          action={
            <Box sx={{ display: 'flex', alignItems: 'center' }}>
              ...
              <Menu keepMounted id='simple-menu' anchorEl={anchorEl} onClose={handleCloseMenu} open={Boolean(anchorEl)}>
                <MenuItem onClick={handleClickNewFile}>New File</MenuItem>
          ...
          <Fragment>
            ...
            <Grid item xs={12} sm={12}>
              <EditorWrapper>
                <CardSnippet
                  sx={{ overflow: 'visible' }}
                  title='Description of the live class'
                  code={{
                    tsx: null,
          ...
          <Fragment key={step}>
            <Grid item xs={12} sm={12}>
              ...
              <Autocomplete
                ...
                renderInput={params => <TextField {...params} placeholder='Add live class tags...' />}
            ...
            <Grid item xs={12} sm={6}>
              ...
              <TextField
                fullWidth
                type='number'
                placeholder='Duration of the  live class'
                value={duration}
...
export default NewLiveClassForm
