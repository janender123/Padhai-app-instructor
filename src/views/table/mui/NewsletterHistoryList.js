...
import { rows } from 'src/@fake-db/table/NewsletterHistoryData'

const escapeRegExp = value => {
  return value.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, '\\$&')
}

const NewsletterHistoryList = () => {
  // ** States
    ...
    },
 {
  ...
  return (
    <Card>
      <CardContent>
        <Button variant='contained'>Send Newsletter</Button>
      </CardContent>
      <DataGrid
...
export default NewsletterHistoryList
