...
// ** Data Import
import { rows } from 'src/@fake-db/table/RecommendedTopicsData'
...
const renderClient = params => {
  ...
  if (row.avatar.length) {
    return <Image  alt='avatar' src={`/images/cards/${row.avatar}`} width={25} height={30} />
...
export default RecommendedTopicsTable
