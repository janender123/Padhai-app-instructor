...
import QuickSearchToolbar from 'src/views/table/data-grid/QuickSearchToolbarBoard'

// ** Utils Import
import { getInitials } from 'src/@core/utils/get-initials'

// ** Data Import
import { rows } from 'src/@fake-db/table/boards-data'
  ...
  if (row.avatar.length) {
    ...
    return (
      <CustomAvatar skin='light' color={color} sx={{ mr: 3, fontSize: '.8rem', width: '1.875rem', height: '1.875rem' }}>
        {getInitials(row.full_name ? row.full_name : 'Board')}
      </CustomAvatar>
    )
  }
}
