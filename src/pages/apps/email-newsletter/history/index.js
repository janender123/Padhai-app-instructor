...
import LiveClassesReports from 'src/views/table/mui/LiveClassesReports'
import NewsletterHistoryList from 'src/views/table/mui/NewsletterHistoryList'
  ...
  return (
    <DatePickerWrapper>
      <Grid container spacing={6}>
        <Grid item xs={12}>
          <Card>
            <CardHeader title='Newsletter History' />
